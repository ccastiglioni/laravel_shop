          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              ...
              <div class="col-sm-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img :src="imagens[0]"   alt="Image placeholder" class="img-fluid"></a>
                  </figure>
              ...
              <div class="col-sm-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img :src="imagens[1]" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="col-sm-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img :src="imagens[2]"  alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0 aos-init aos-animate" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img :src="imagens[3]" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0 aos-init aos-animate" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img  :src="imagens[4]"  alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Children</h3>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0 aos-init aos-animate" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img :src="imagens[5]"  alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Men</h3>
        ...
        data(){
            return {
                imagens:[
                    ...
                    'imagens/shoe_1.jpg',
                    'imagens/cloth_2.jpg',
                    'imagens/women.jpg', // women
                    'imagens/children.jpg', //clidren
                    'imagens/men.jpg', //men
                    'imagens/cloth_2.jpg',
                    'imagens/cloth_3.jpg',
                    'imagens/shoe_1.jpg',
