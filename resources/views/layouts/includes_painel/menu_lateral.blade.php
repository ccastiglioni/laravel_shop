    ...
    <div class="navbar-wrapper">
        <div class="navbar-brand header-logo">
            <a href="index.html" class="b-brand">
                ...
                <span class="b-title">Laravel Vue</span>
            </a>
            ...
            <ul class="nav pcoded-inner-navbar">
              ...
              {{--   <li class="nav-item pcoded-menu-caption">
                ...
                <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">WebSite</span></a>
                    <ul class="pcoded-submenu">
                          <li class=""><a href="{{ route('produtos.index') }}" class="">Produtos</a></li>
                          <li class=""><a href="{{ route('categorias.index') }}" class="">Categorias</a></li>
                          <li class=""><a href=" " class="">Usuários</a></li>
                          <li class=""><a href=" " class="">Compras</a></li>
                        ...
                        <li class=""><a href="dashboard-crm.html" class="">dashboard-crm<span class="pcoded-badge label label-danger">NEW</span></a></li> --}}
                    </ul>
                </li>
                <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    <a href="javascript:" class="nav-link ">
                        <span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Configurações</span></a>
                    <ul class="pcoded-submenu">
                          <li class=""><a href="" class="">Empresa</a></li>
...
{{--
                ...
                <li data-username="Sample Page" class="nav-item"><a href="sample-page.html" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Sample page</span></a>
                </li>
                <li data-username="Disabled Menu" class="nav-item disabled"><a href="javascript:" class="nav-link"><span class="pcoded-micon"><i class="feather icon-power"></i></span><span class="pcoded-mtext">Disabled menu</span></a>
                </li> --}}
