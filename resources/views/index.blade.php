                ...
                <div class="container">
                  <ul class="site-menu js-clone-nav d-none d-md-block">
                    ...
                    <li class="has-children">
                      <a href="about.html">Linguagem</a>
                      <ul class="dropdown">
                        @include('layouts/includes/language_switcher')
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li><a href="#">{{ __('messages.catalogue') }}</a></li>
            <li><a href="#">{{ __('messages.promo') }}</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="{{ asset('imagens/hero_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded mb-4">
